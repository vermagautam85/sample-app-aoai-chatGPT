                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start chatting with Private ChatGPT for GautamEU Organization</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>AI assistant that helps people find information for GautamEU Organization.</h2>
                            </Stack>
                        ) : (
